...
const addUtm = (url) => {
  ...
  try {
    ...
    u.searchParams.set("utm_campaign","phoenix-summer-camps");
    return u.toString();
  } catch(e){ return url; }
};
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
            <div style={{flex:1}}>
              <div style={{display:"flex",gap:6,marginBottom:8,flexWrap:"wrap"}}>
                ...
                {camp.lunch&&<span style={{fontSize:11,fontWeight:600,padding:"3px 10px",borderRadius:20,background:"#FFF7ED",color:"#9A3412",fontFamily:"'DM Sans',sans-serif"}}>🍽️ Lunch</span>}
                {camp.snacks&&<span style={{fontSize:11,fontWeight:600,padding:"3px 10px",borderRadius:20,background:"#FFF7ED",color:"#9A3412",fontFamily:"'DM Sans',sans-serif"}}>🍎 Snacks</span>}
              </div>
        ...
        {expanded&&(
          <div style={{borderTop:`1.5px solid #E8D5A0`,padding:20,background:SKY}}>
            <div style={{fontSize:13,color:"#4A3520",fontFamily:"'DM Sans',sans-serif",display:"flex",flexDirection:"column",gap:7,marginBottom:14}}>
              ...
              {camp.web&&<p style={{margin:0}}><strong style={{color:"#2D1A08"}}>Website:</strong> <a href={addUtm(camp.web)} target="_blank" rel="noopener noreferrer" style={{color:BLUE,textDecoration:"none",fontWeight:600}}>{camp.web}</a></p>}
          ...
          <div style={{background:"rgba(255,255,255,0.12)",borderRadius:"14px 14px 0 0",padding:"14px 14px 18px",backdropFilter:"blur(10px)"}}>
            ...
            <div style={{display:"flex",gap:8}}>
              <input style={{flex:1,border:"none",borderRadius:10,padding:"12px 16px",fontSize:13,outline:"none",background:"white",fontFamily:"'DM Sans',sans-serif",color:"#2D1A08",boxShadow:"0 2px 8px rgba(0,0,0,0.1)"}}
                placeholder='e.g. "robotics" or "YMCA" or "Scottsdale" or "dance"'
